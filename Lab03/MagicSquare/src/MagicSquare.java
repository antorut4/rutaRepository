...
public class MagicSquare {
    ...
    public boolean isMagic() {
        ...
        //Somma tutte le righe esclusa la prima e controlla che la somma sia uguale alla somma della prima
        ...
        //Sommo le colonne e confronto la loro somma con la prima somma
        if(isMagic){
            for(int i=0;i<n;i++){
                sum=0;
                for(int j=0;j<n;j++){
        ...
        //sommo le diagonali e confronto con la prima somma
        if (isMagic) {
            sum=0;
            int j = 0;
            for (int i = n - 1; i >= 0; i--) {
